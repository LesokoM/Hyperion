...
def login():
    ...
    user_input = user_username+","+user_password
...
'''
    ...
    for line in user_login_details:
        ...
        print(line)
        username_password.append( line.split(","))
            

    print(username_password)
    print(username_password[0])
    
    print(username_password[0][1])

    
      


    #so we know that odd numbers will be usernames
    #odd numbers will be passwords
